    ...
    <div class="btn-controls">
        <div class="btn-box-row row-fluid" >
            <button class="btn-box span12" style="background: #00cc00; ">
                <b style="color:#fff">Hệ thống quản lý thư viện HNC</b>
            </button>
        </div>
                ...
                <div class="module-body">
                    <form class="form-horizontal row-fluid" id="findbookform">
                        <div class="control-group">
                            <label class="control-label">Tên hoặc tác giả<br> của cuốn sách</label>
                            <div class="controls">
                                <div class="span9">
                                    <textarea class="span12" rows="2"></textarea>
                                </div>
                                <div class="span3">
                                    <a class="btn homepage-form-submit " style="background-color:  #00cc00; color:#fff"><i class="icon-search"></i> Tìm kiếm</a>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="module" style="display: none;">
                <div class="module-body">
                    <form class="form-horizontal row-fluid" id="findissueform">
                        <div class="control-group">
                            <label class="control-label">Nhập sách ID</label>
                            <div class="controls">
